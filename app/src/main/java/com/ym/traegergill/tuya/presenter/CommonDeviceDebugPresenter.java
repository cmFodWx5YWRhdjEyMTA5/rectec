...
import com.ym.traegergill.tuya.bean.DpLogBean;
import com.ym.traegergill.tuya.presenter.firmware.FirmwareUpgradePresenter;
...
import com.ym.traegergill.tuya.view.ICommonDeviceDebugView;
...
public class CommonDeviceDebugPresenter extends BasePresenter implements IDevListener {
    ...
    private void initData() {
        mDevId = ((Activity) mContext).getIntent().getStringExtra(RemoteControlActivity.INTENT_DEVID);
        OUtil.TLog("mDevId : " + mDevId);
    ...
    public void sendCommand(String dpId, Object value) {
    ...
    public void renameDevice() {
        DialogUtil.simpleInputDialog(mContext, mContext.getString(R.string.rename), getTitle(), false, new DialogUtil.SimpleInputDialogInterface() {
            ...
            public void onPositive(DialogInterface dialog, String inputText) {
                int limit = 25;//mContext.getResources().getInteger(R.integer.change_device_name_limit);
