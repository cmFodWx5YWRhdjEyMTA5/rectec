    ...
    public static class FullActivityBuilder {
        ...
        public void go(OnAnimationEndListener onAnimationEndListener) {
           ...
           // view.setImageResource(mColorOrImageRes);
            view.setImageDrawable(mActivity.getResources().getDrawable(mColorOrImageRes));
            //view.setImageBitmap(BitmapFactory.decodeResource(mActivity.getResources(), mColorOrImageRes));
            final ViewGroup decorView = (ViewGroup) mActivity.getWindow().getDecorView();
            int w = decorView.getWidth();
            int h = decorView.getHeight();
            //
            int navigationBarHeight = OUtil.getNavigationBarHeight(mActivity);
